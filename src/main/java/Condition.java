...
public class Condition {
    ...
    public boolean evaluate(Path path) {
        ...
        if (entity.equals("stops")) {
            rc = operation.evaluate(path.getStops(), value);
        } else if (entity.equals("distance")) {
            rc = operation.evaluate(path.getDistance(), value);
        } else {
            throw new IllegalArgumentException(Application.getProperty("unknown_entity") + ": " + entity);
        }
        return rc;
    }
    ...
    public Condition(String operator, int value, String entity) {
        ...
        if (this.operation == null) {
            throw new IllegalArgumentException(Application.getProperty("unknown_operator") +": " + operator);
        }
        this.value  = value;
        this.entity = entity;
    }
