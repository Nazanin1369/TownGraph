...
public class Dijkstra {
    ...
    /**
     * Performs Dijkstra algorithm to calculate the shortest
     * possible path between a start and end node
     * @param graph
     * @param start
     * @param end
     * @return
     */
    public static int run(Graph graph, Node start, Node end) {
        ...
        while(!unsettled.isEmpty()) {
            ...
            for (Edge edge : nearest.getAdjacents()) {
